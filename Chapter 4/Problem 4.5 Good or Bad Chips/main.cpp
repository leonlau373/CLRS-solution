/*
Name: Leon Lau (nya10)
Notes: This is not a solution to the problem, but I'm just merely do a game based on this problem. If you can figure out the strategy, you can win all the time.
*/
...
//DO NOT SCROLL BELOW THIS POINT IF YOU WANT TO WORK ON THIS PROBLEM, I'LL UPDATE THE SOLUTION OUTLINE BELOW
...
//Take note in this game, the bad chip will always tell a lie,
